...
//			+ "		(str(?endDateTimeValueForGrant) as ?grantEndDateForGrantLit)  "			
	...
	private CoInvestigationData getCachedData(String egoURI) {
		if(collaborationDataCache != null && StringUtils.isNotBlank(egoURI) && collaborationDataCache.containsKey(egoURI)){
	...
	private synchronized CoInvestigationData getQueryResultAndCache()
		...
		if (StringUtils.isNotBlank(this.egoURI)) {
			...
			throw new MalformedQueryParametersException("No specific researcher is selected for rendering the graph");
		}
