...
public class VitroSearchTermNames {
    ...
    /** Customisation - download URL for thumbnail image */
    public static final String THUMBNAIL_DOWNLOAD_URL = "THUMBNAIL_DOWNLOAD_URL";
    ...
    public static final String AUTHOR_OF_PUBS_COUNT = "op_label_authorOfPubsCount"; // 
