        ...
        return $(
            '<div class="ui-multiselect2" style="position:relative">'+
                ...
                '<div id="' + gridA_IDs.filterID + '" class="actions ui-widget-header ui-helper-clearfix search-cell search-cell-left">'+
                    '<input class="textFilter" type="text" id="' + gridA_IDs.searchID + '" placeholder="available items">'+
                ...
                '<div id="' + gridS_IDs.filterID + '" class="actions ui-widget-header ui-helper-clearfix search-cell search-cell-right">'+
                    '<input class="textFilter" type="text" id="' + gridS_IDs.searchID + '" placeholder="selected items">'+
                ...
                '<tr class="ui-dual-grid">'+
                            '</td>'+
                            '<td>'+
                                '<span id="' + gridA_IDs.ID + '" style="float:left;width:100%;height:300px;" class="search-grid-left-col"></span>'+
                            '</td>'+
                            '<td>'+
                                '<span id="' + gridS_IDs.ID + '" style="float:left;width:100%;height:300px;" class="search-grid-right-col"></span>'+
                            '</td>'+
                        '</tr>'+
                    '</table>'+
                '</div>'+
...
//                forceFitColumns: true,
    ...
    */
    getActive: function() {
        var keys;
        var facets = [];
        if (keys = this.manager.store.find('fq', this.field)) {
    ...
    */
    popupOptions: function(left,top) {
        var self = this;
        ...
        return {
            ...
            width: '800',
            height: 'auto',
            position:[left, top - jQuery(document).scrollTop() - 56],
            overflow: 'auto',
            buttons: {
                'Update': {
                    text: 'Update',
