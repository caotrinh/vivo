...
<%
    // Close DB connection if we are presenting the 404 page (SCHOLDEV-469)
    HttpServletRequestWrapper requestWrapper = ((HttpServletRequestWrapper)((HttpServletRequestWrapper) request).getRequest());
    if(requestWrapper != null && requestWrapper.getRequestURI() != null && requestWrapper.getRequestURI().indexOf("/templates/error/error404.jsp") == 0 ) {
        FreemarkerHttpServlet.closeModel(request);
    }
%>