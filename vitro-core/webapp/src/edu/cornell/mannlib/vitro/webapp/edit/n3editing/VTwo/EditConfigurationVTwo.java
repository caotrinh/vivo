...
public class EditConfigurationVTwo {
	...
	boolean createAndStayOnEditPage;
    ...
    public boolean isCreateAndStayOnEditPage(){
    	return createAndStayOnEditPage;
    }
    
    public void setCreateAndStayOnEditPage(boolean createAndStayOnEditPage){
    	this.createAndStayOnEditPage = createAndStayOnEditPage; 
    }
}
