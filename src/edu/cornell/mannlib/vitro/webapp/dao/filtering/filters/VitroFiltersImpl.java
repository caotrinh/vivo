...
public class VitroFiltersImpl extends VitroFiltersBase {
   ...
   /** filter for DataProperty objects */
    ...
    //hacky way of filtering all individuals which is hideFromDisplay
    final static String hideFromDisplay ="http://vivoweb.org/ontology/core#hideFromDisplay";
    
    private class IndividualFilterByHideFromDisplay extends UnaryFunctor<Individual, Boolean>{
		@Override
		public Boolean fn(Individual ind){
			return !Boolean.valueOf(ind.getDataValue(hideFromDisplay));
		}
	}
    ...
    public VitroFiltersImpl(){
        individualFilter = new IndividualFilterByHideFromDisplay();
