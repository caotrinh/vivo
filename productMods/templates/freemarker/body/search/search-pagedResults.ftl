...
<script type="text/javascript">
    ...
    <#function isHiddenType type>
        <#assign hiddenTypes = ['Person', 'Staff', 'organizations', 'Academic Department', 'Department', 'Facility', 'Group', 'Organization']>
        <#return hiddenTypes?seq_contains(type)>
    </#function>
...
<#if classGroupLinks?has_content>
    <div class="row">
        <div class="col-xs-10 col-xs-offset-1">
            <div class="centerSearchTOC visible-xs">
                <h4>${i18n().display_only}</h4>
                <ul>
                    <#list classGroupLinks as link>
                        <#if !isHiddenType(link.text) >
...
${stylesheets.add('<link rel="stylesheet" href="https://code.jquery.com/ui/1.10.3/themes/smoothness/jquery-ui.css" />',
  				  '<link rel="stylesheet" href="${urls.base}/css/search.css" />')}

${headScripts.add('<script src="https://code.jquery.com/ui/1.10.3/jquery-ui.js"></script>',
