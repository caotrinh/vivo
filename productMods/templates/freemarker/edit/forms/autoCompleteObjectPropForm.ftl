    ...
    <#if rangeOptionsExist  = true >
        <form class="customForm" action = "${submitUrl}">
            ...
            <p>
				...
				<input class="acSelector" size="50" style="display:block;" type="text" id="object" name="objectLabel" acGroupName="object" value="${objectLabel}" />
			</p>
								
			<div class="acSelection" acGroupName="object" > 
				<p class="inline">
					<label style="display:block;">${i18n().selected}:</label> 
            ...
            <p>
                <input type="submit" id="submit" value="${submitButtonText}" class="btn btn-primary" role="button" disabled="disabled"/>
