...
<div class="panel-heading">${titleVerb}&nbsp;${i18n().advisee_relationship_entry_for} ${editConfiguration.subjectName}</div>
...
<section id="personHasAdvisingRelationship" role="region">        
    ...
    <hr/>
    <p >
        <label for="advisor">${i18n().advisor_capitalized}: ${i18n().last_name_or_auto_complete}  ${requiredHint}</label>
        <input class="acSelector" size="50" style="display:block;" type="text" acGroupName="advisor" id="advisor" name="advisorLabel" value="${advisorLabelValue}" >
        <input type="text" size="50"  id="maskLabelBuilding" name="maskLabelBuilding" value="" style="display:none" >
        <label style="display:block;">${i18n().first_name}  ${requiredHint}</label>
        <input style="display:block;" size="30"  type="text" id="firstName" name="firstName" value="${firstNameValue}" >
    ...
    <div class="acSelection" acGroupName="advisor" id="advisorAcSelection">
        <p class="inline">
            <label style="display:block;">${i18n().selected_advisor}
